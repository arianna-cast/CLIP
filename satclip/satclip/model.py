...
class SatCLIP(nn.Module):
    ...
    def forward(self, image, coords):
        ...
        logits_per_image = logit_scale * image_features @ location_features.t() #bxf fxb = bxb
        logits_per_location = logits_per_image.t()

        # shape = [global_batch_size, global_batch_size]
        return logits_per_image, logits_per_location #per ogni immagine (riga) ho la distanza da tutte le location --> immagine in CLIP
